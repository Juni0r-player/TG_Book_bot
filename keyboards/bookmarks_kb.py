"""Настраивается после pagination_kb.py"""
"""Отвечает за клавиатуры для работы с закладками пользователя"""
...
# Функция create_bookmarks_keyboard генерирует список закладок формата
# {номер страницы} - {Начальный текст страницы} в виде инлайн-кнопок (каждая кнопка на новой строке),
# а также еще две кнопки - "Редактировать" и "Отменить":
